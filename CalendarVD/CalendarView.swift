...
extension CalendarView: UICollectionViewDelegateFlowLayout {
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let height: CGFloat = (collectionView.frame.height - monthView.frame.height) / CGFloat((getNumberOfDaysInMonth(currentMonthIndex-1, currentYear) + firstWeekDayOfMonth - 1)/7)
        
        print("WIDTH")
        print(width)
        print("HEIGHT")
        print(height)
        print(collectionView.frame.height / CGFloat((getNumberOfDaysInMonth(currentMonthIndex-1, currentYear) + firstWeekDayOfMonth - 1)/7))
